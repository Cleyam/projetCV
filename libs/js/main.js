...
$(function () {
    ...
    $.ajax({
        ...
        $.each(data, function(key, val){
            let ajout = "<hr><div id=\'experience" + key + "\' class=\'formation row\'><div id=\'periode" + key + "\' class=\'col-12\'>" + val.periode + "</div><div class=\'col-12\'><p  id=\'name" + key + "\' class=\'font-weight-bold\'>" + val.name + "</p><div id=\'place" + key + "\' class=\'font-weight-bold\'>" + val.place + "</div><div id=\'detail" + key + "\'><ul class=\'text-left\'>";
            for (let loopLI = 0; loopLI < val.detail.length; loopLI++) {
                ajout += "<li class=\'experienceDetail\'>" + val.detail[loopLI] + "</li>"
            }
